  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute left-0 sm:left-auto sm:right-0 mt-2 w-[90vw] max-w-[350px] sm:w-[350px] flex flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        ...
        <ul className="flex flex-col h-auto max-h-[70vh] overflow-y-auto custom-scrollbar">
